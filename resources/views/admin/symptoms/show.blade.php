...
@section('header_actions')
    <a href="{{ route('admin.symptoms.edit', $symptom) }}" class="inline-flex items-center justify-center rounded-md bg-teal-700 px-4 py-2 text-sm font-semibold text-white transition hover:bg-teal-800">Edit</a>
@endsection
