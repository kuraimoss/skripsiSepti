...
@section('header_actions')
    <a href="{{ route('admin.symptoms.edit', $symptom) }}" class="inline-flex w-full items-center justify-center gap-2 rounded-md bg-teal-700 px-4 py-2 text-sm font-semibold text-white transition hover:bg-teal-800 sm:w-auto">
    ...
    <section class="rounded-lg border border-slate-200 bg-white p-5 shadow-sm">
        ...
        <dl class="grid gap-5 sm:grid-cols-2">
            ...
            <div>
                ...
                <dd class="mt-1 text-sm font-semibold text-slate-950">{{ $formatBelief($symptom->belief) }}</dd>
            </div>
