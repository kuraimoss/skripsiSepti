    ...
    <section class="bg-white">
        <div class="mx-auto max-w-6xl px-4 py-10 sm:px-6 lg:px-8">
            <div class="grid gap-8 lg:grid-cols-[1fr_360px] lg:items-center">
                ...
                <img src="{{ asset('images/consultation-form.svg') }}" alt="Ilustrasi form konsultasi dan pilihan gejala" class="w-full rounded-lg border border-slate-200 bg-slate-50 object-cover shadow-sm">
            </div>
