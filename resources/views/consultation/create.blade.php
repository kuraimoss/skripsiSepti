...
@section('content')
    <section class="bg-white">
        <div class="mx-auto max-w-6xl px-4 py-10 sm:px-6 lg:px-8">
            <div class="max-w-3xl">
                <p class="text-sm font-semibold text-teal-700">Konsultasi</p>
            ...
            <form method="POST" action="{{ $submitUrl }}" class="mt-8 space-y-6">
                ...
                <section class="rounded-lg border border-slate-200 bg-slate-50 p-5">
                    <h2 class="text-base font-semibold text-slate-950">Konteks keluarga</h2>
                    <div class="mt-5 grid gap-4 md:grid-cols-2">
                        <div>
                ...
                <div class="flex flex-col-reverse gap-3 border-t border-slate-200 pt-6 sm:flex-row sm:justify-end">
                    <a href="{{ \Illuminate\Support\Facades\Route::has('home') ? route('home') : url('/') }}" class="inline-flex items-center justify-center rounded-md border border-slate-300 bg-white px-5 py-3 text-sm font-semibold text-slate-700 transition hover:bg-slate-100">
                        Batal
                    </a>
                    <button type="submit" class="inline-flex items-center justify-center rounded-md bg-teal-700 px-5 py-3 text-sm font-semibold text-white shadow-sm transition hover:bg-teal-800">
                        Proses Konsultasi
                    </button>
                </div>
            </form>
