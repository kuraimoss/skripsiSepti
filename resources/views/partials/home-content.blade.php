    ...
    <div class="mx-auto grid max-w-7xl gap-10 px-4 py-14 sm:px-6 lg:grid-cols-[1.05fr_0.95fr] lg:px-8 lg:py-20">
        <div class="flex flex-col justify-center">
            ...
            <div id="konsultasi" class="mt-8 flex flex-col gap-3 sm:flex-row">
                <a href="{{ \Illuminate\Support\Facades\Route::has('consultation.create') ? route('consultation.create') : '#' }}" class="inline-flex items-center justify-center gap-2 rounded-md bg-teal-700 px-5 py-3 text-sm font-semibold text-white shadow-sm transition hover:bg-teal-800">
                    Mulai Konsultasi
                    <x-icon name="arrow-right" class="size-4" />
                </a>
                <a href="{{ \Illuminate\Support\Facades\Route::has('info') ? route('info') : '#info' }}" class="inline-flex items-center justify-center gap-2 rounded-md border border-slate-300 bg-white px-5 py-3 text-sm font-semibold text-slate-700 transition hover:bg-slate-100">
        ...
        <div class="self-center space-y-4">
                <img src="{{ asset('images/landing-hero.svg') }}" alt="Ilustrasi sesi konsultasi kesehatan mental remaja" class="w-full rounded-lg border border-slate-200 bg-slate-50 object-cover shadow-sm">

            <div class="rounded-lg border border-slate-200 bg-slate-50 p-6">
                <p class="flex items-center gap-2 text-sm font-semibold text-slate-950">
                    <x-icon name="clipboard-check" class="size-4 text-teal-700" />
                    Alur singkat
                </p>
                <div class="mt-5 space-y-4">
                    <div class="flex gap-4 rounded-md bg-white p-4">
                        <span class="grid size-8 shrink-0 place-items-center rounded-full bg-teal-100 text-teal-800">
    ...
    <div class="mx-auto grid max-w-7xl gap-6 px-4 py-10 sm:px-6 md:grid-cols-3 lg:px-8">
        <article class="rounded-lg border border-slate-200 bg-white p-5">
            <div class="grid size-10 place-items-center rounded-md bg-teal-50 text-teal-800">
                <x-icon name="clipboard-list" class="size-5" />
            </div>
            <h2 class="mt-4 text-base font-semibold text-slate-950">Konsultasi</h2>
        ...
        <article class="rounded-lg border border-slate-200 bg-white p-5">
            ...
            <h2 class="mt-4 text-base font-semibold text-slate-950">Basis pengetahuan</h2>
            <p class="mt-2 text-sm leading-6 text-slate-600">Admin mengelola gejala, gangguan, dan nilai belief.</p>
        </article>
        <article class="rounded-lg border border-slate-200 bg-white p-5">
            <div class="grid size-10 place-items-center rounded-md bg-teal-50 text-teal-800">
                <x-icon name="history" class="size-5" />
            </div>
            <h2 class="mt-4 text-base font-semibold text-slate-950">Riwayat</h2>
