    ...
    <section class="bg-white">
        <div class="mx-auto max-w-5xl px-4 py-12 sm:px-6 lg:px-8">
            <div class="grid gap-8 rounded-lg border border-slate-200 bg-slate-50 p-6 md:p-8 lg:grid-cols-[1fr_320px] lg:items-center">
                ...
                <img src="{{ asset('images/expert-profile.svg') }}" alt="Ilustrasi pakar memvalidasi basis pengetahuan" class="w-full rounded-lg border border-slate-200 bg-white object-cover shadow-sm">
            </div>
