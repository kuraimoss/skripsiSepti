...
class ExpertSystemSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $symptoms = collect([
            ...
            ['code' => 'G05', 'name' => 'Merasa cemas berlebih', 'belief' => 0.4],
            ['code' => 'G06', 'name' => 'Tidak memiliki rasa percaya diri', 'belief' => 0.3],
            ['code' => 'G07', 'name' => 'Sedih berkepanjangan', 'belief' => 0.4],
            ['code' => 'G08', 'name' => 'Overthinking', 'belief' => 0.5],
            ['code' => 'G09', 'name' => 'Sering menderita sakit kepala', 'belief' => 0.3],
            ['code' => 'G10', 'name' => 'Tidak memiliki nafsu makan', 'belief' => 0.3],
            ['code' => 'G11', 'name' => 'Sulit tidur', 'belief' => 0.4],
            ['code' => 'G12', 'name' => 'Mudah takut', 'belief' => 0.2],
            ['code' => 'G13', 'name' => 'Aktivitas terganggu', 'belief' => 0.3],
            ['code' => 'G14', 'name' => 'Sulit berpikir jernih', 'belief' => 0.5],
