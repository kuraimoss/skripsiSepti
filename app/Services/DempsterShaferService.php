...
class DempsterShaferService
{
    ...
    private function defaultKnowledgeBase(): array
    {
        return [
            ...
            'G05' => ['code' => 'G05', 'name' => 'Sulit berpikir jernih', 'belief' => 0.5, 'disorders' => ['P01']],
            'G06' => ['code' => 'G06', 'name' => 'Tidak memiliki nafsu makan', 'belief' => 0.3, 'disorders' => ['P01']],
            'G07' => ['code' => 'G07', 'name' => 'Aktivitas terganggu', 'belief' => 0.3, 'disorders' => ['P01']],
            'G08' => ['code' => 'G08', 'name' => 'Overtinhking', 'belief' => 0.5, 'disorders' => ['P01', 'P02']],
            'G09' => ['code' => 'G09', 'name' => 'Merasa cemas berlebih', 'belief' => 0.4, 'disorders' => ['P02']],
            'G10' => ['code' => 'G10', 'name' => 'Tidak memiliki rasa percaya diri', 'belief' => 0.3, 'disorders' => ['P02']],
            'G11' => ['code' => 'G11', 'name' => 'Sulit tidur', 'belief' => 0.4, 'disorders' => ['P02']],
            'G12' => ['code' => 'G12', 'name' => 'Mudah takut', 'belief' => 0.2, 'disorders' => ['P02']],
            'G13' => ['code' => 'G13', 'name' => 'Sering menderita sakit kepala', 'belief' => 0.3, 'disorders' => ['P02']],
            'G14' => ['code' => 'G14', 'name' => 'Sedih berkepanjangan', 'belief' => 0.4, 'disorders' => ['P02']],
